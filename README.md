...
In this *"Tech Basics 1"* class we are going to learn **python**.
![python logo](https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Python-logo-notext.svg/219px-Python-logo-notext.svg.png)
